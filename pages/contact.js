  ...
  sendEmail() {
    if (this.state.feedback != 'loading') {
      ...
      if (valid) {
        ...
        emailjs.send('default_service','vs_insoumis_contact', {
    ...
    return (
      <Container id="contact">
        <Row>
          ...
          <p>Cet outil est une ébauche de comparateur de programme. Les thèmes manquants seront ajoutés très prochainement. En attendant n'hésitez pas à nous faire part de vos remarques :)</p>
